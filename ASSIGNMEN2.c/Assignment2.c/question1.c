/********************************************************************************************************************************
1. Write a C program to check whether a given email address is valid or not. The rule for email ID  is given in the following link- https://en.wikipedia.org/wiki/Email_address 
"2115082"
********************************************************************************************************************************/
